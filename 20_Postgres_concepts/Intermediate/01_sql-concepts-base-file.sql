...
DROP TABLE IF EXISTS intermediate.products;
...
INSERT INTO intermediate.products (name, category, price, stock, is_active, sku, description)
  VALUES
...
SELECT * FROM intermediate.products;